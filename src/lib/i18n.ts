...
const zh = {
  "lang.label": "语言",
  "boot.go": "开始养",
  "boot.title": "写进账本，岛上就长出来",
  "boot.body": "可玩的 Effect EventLog 演示。太阳岛和月亮岛，各自一本只能往后写的账。",
...
const en: Record<keyof typeof zh, string> = {
  ...
  "boot.title": "Write it down. It grows on the isle.",
  "boot.body": "A playable Effect EventLog demo. Sun Isle and Moon Isle each keep a journal you can only append to.",
