  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "primary" && "border-accent-deep bg-accent text-accent-fg",
        variant === "sky" && "border-sky-deep bg-sky text-accent-fg",
        variant === "sun" && "border-sun-deep bg-sun text-fg",
        variant === "grape" && "border-grape-deep bg-grape text-accent-fg",
        variant === "ghost" && "border-transparent bg-transparent text-fg",
        variant === "outline" && "border-faint bg-surface text-fg",
        variant === "danger" && "border-[#d93838] bg-danger text-accent-fg",
